...
public class playerControls2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.RightArrow) && pepperIndexA != 7 || Input.GetKeyDown(KeyCode.D) && pepperIndexA != 7)
        {
            isRunning = true;
        ...
        if (Input.GetKeyDown(KeyCode.LeftArrow) && pepperIndexA != 7 || Input.GetKeyDown(KeyCode.A) && pepperIndexA != 7)
        {
            isRunning = true;
            anim.SetInteger("Speed", 1);
            transform.localScale = new Vector3(-1, 1, 1);
        ...
        if (Input.GetKeyDown(KeyCode.Space) && pepperIndexA != 0)
        {

            isAttack = true;
        }
        else if (Input.GetKeyDown(KeyCode.Space) && pepperIndexA == 0)
        {
            isAttack = false;
        }
        else if (Input.GetKeyUp(KeyCode.Space) && pepperIndexA != 0)
        {
            isAttack = false;
        }
      ...
      && Input.GetKeyUp(KeyCode.A) && Input.GetKeyUp(KeyCode.D) && Input.GetKeyUp(KeyCode.Space))
        {
            isAttack = false;
            isRunning = false;
            // anim. = 0f;
        ...
        if (Input.GetKeyUp(KeyCode.LeftArrow) && Input.GetKeyUp(KeyCode.Space) && Input.GetKeyUp(KeyCode.RightArrow)
        && Input.GetKeyUp(KeyCode.A) && Input.GetKeyUp(KeyCode.D) && Input.GetKeyUp(KeyCode.Space))
        {
            isRunning = false;
            isAttack = false;
        ...
        if (isAttack == true && isRunning == true)
        {
            anim.SetInteger("Speed", 4);
        }
        if (isRunning == false && Input.GetKeyUp(KeyCode.Space) && Input.GetKeyUp(KeyCode.LeftArrow) && Input.GetKeyUp(KeyCode.RightArrow)
            && Input.GetKeyUp(KeyCode.A) && Input.GetKeyUp(KeyCode.D))
        {
            anim.SetInteger("Speed", 0);
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        if (collider.gameObject.tag == "enemyFist")
        {
            if (!isImmune)
            {
                ...
                if (isAttack == false && isRunning == false)
                {
